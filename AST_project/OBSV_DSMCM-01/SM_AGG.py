...
# -*- coding: utf-8 -*-
"""
SM_AGG.py – High‑Precision Astronomical Ephemeris Orchestrator
================================================================
Menggabungkan semua modul inti (VSOP87A, ELP/MPP02, EarthRotation,
...
class AstronomicalEphemeris:
    ...
    def earth_heliocentric_ecliptic(self, tt_jd: float) -> Tuple[np.ndarray, np.ndarray]:
        ...
        x, y, z, vx, vy, vz = self.vsop_earth.compute(tdb)
    ...
    def earth_velocity_gcrs(self, tt_jd: float) -> np.ndarray:
        # VSOP87A "ear" mengembalikan kecepatan Bumi sesungguhnya (bukan EMB)
        _, v_earth_ecl = self.earth_heliocentric_ecliptic(tt_jd)
        # Rotasi dari ekliptika FK5 ke ekuator FK5
        R = rot_x(-84381.406 * ARCSEC_TO_RAD)
...
if __name__ == "__main__":
    ...
    print("Initializing High-Precision Orchestrator with DoV & Ellipsoidal Height...")
    ...
    print(" WITH DOPPLER (DoV) & ELLIPSOIDAL HEIGHT CORRECTIONS")
    print("=" * 80)
